...
SELECT DISTINCT concat( Members.firstname, ' ', Members.surname ) Member, x.name Court
FROM Members
...
SELECT	Facilities.name Facility,
	concat( Members.firstname, ' ', Members.surname ) Member,
...
JOIN Members
ON BFjoin.memid = Members.memid
WHERE BFjoin.cost > 30
ORDER BY BFjoin.cost DESC
